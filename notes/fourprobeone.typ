...
!\[\[Pasted image 20251127035603.png\]\] (Source: #footnote[Four-Point
AC Resistance Measurements, Paul M. Neves, SRS Technique Paper TP2401];)

Here, we discuss the four-terminal AC resistance measurement as an
alternative to the simple two-probe DC measurement.

!\[\[Pasted image 20251127035821.png\]\] (Source: #footnote[Four-Point
AC Resistance Measurements, Paul M. Neves, SRS Technique Paper TP2401];)
